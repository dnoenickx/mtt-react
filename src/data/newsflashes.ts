...
export const newsflashes: Newsflash[] = [
  ...
  },
  {
    ...
    datePrecision: 'day',
    description:
      'Plans for extension from Lahey Medical Center across Route 128 to Endicott Street, connecting it to downtown Peabody. The project includes a 10-foot shared-use path with dedicated bike lanes and buffers, repurposing a motor vehicle lane under Route 128, and building a boardwalk along Proctor Brook to protect wetlands. Final design plans are due by January 2023, with construction set to begin in Spring 2024 and finish within a year.',
    icon: '',
    segmentIds: [5891],
    links: [
      {
        url: 'https://mass.streetsblog.org/2022/06/27/new-paths-in-peabody-will-fill-missing-links-on-border-to-boston-trail',
        label: 'Mass Streets Blog',
      },
      {
        url: 'https://www.mass.gov/event/peabody-independence-greenway-extension-2022-06-22t183000-0400-2022-06-22t200000-0400',
        label: 'MassDOT Event',
      },
    ],
  },
  ...
  },
  {
    ...
    datePrecision: 'year',
    description: 'Spring 2026, according to 1/3/2024 meeting',
    icon: '',
    segmentIds: [5430],
    links: [],
  },
  ...
  {
    id: 7451,
    headline: '25% Design Meeting',
    date: new Date(2024, 1, 3),
    datePrecision: 'day',
    description:
      'Plans shown for a 1.25-mile shared-used path that is 10-12ft wide with gravel shoulders. It will follow Lowell Street under I-95 and include new pedestrian bridges across Route-1 and Proctor Brook.',
    icon: '',
    segmentIds: [5430],
    links: [
      {
        url: 'https://www.mass.gov/doc/massdot-hearing-presentation-peabody-13024/download',
        label: 'Mass DOT Presentation',
      },
    ],
  },
  {
