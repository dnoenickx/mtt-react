...
export const lightStyle = {
  ...
  layers: [
    ...
    // Light wide red base
    {
      id: 'boundaries_locality_base',
      type: 'line',
      source: 'protomaps',
      'source-layer': 'boundaries',
      filter: ['all', ['<=', 'kind_detail', 8], ['>=', 'kind_detail', 6]],
      paint: {
        'line-color': '#f28c8c',
        'line-width': 3,
...
export const darkStyle = {
  ...
  layers: [
    ...
    },
    {
      ...
      paint: {
        'line-color': ['interpolate', ['exponential', 1.6], ['zoom'], 11, '#3d3d3d', 16, '#333333'],
        'line-width': [
          'interpolate',
          ['exponential', 1.6],
          ['zoom'],
    ...
    // TODO: might want to make borders of town more apparent like in light mode
    {
      id: 'boundaries',
      type: 'line',
      source: 'protomaps',
